...
public class SectionCFAActivity extends AppCompatActivity {

    private static final String TAG = SectionCFAActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_section_cfa);
