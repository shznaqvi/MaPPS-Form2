...
public class SectionCIBActivity extends Activity {

    private static final String TAG = SectionCIBActivity.class.getSimpleName();
    ...
    void onBtnContinueClick() {
        ...
        if (ValidateForm()) {
            ...
            if (UpdateDB()) {
                ...
                finish();
                Intent secchc = new Intent(this, SectionCICActivity.class);
